      ...
      <div className="container-w relative z-10">
        ...
        {submitted ? (
          <div style={{ textAlign: 'center', padding: '32px 0' }}>
            ...
            <p style={{ fontFamily: 'var(--sans)', fontSize: 20, fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', color: '#fff', marginBottom: 8 }}>Thank You!</p>
            <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 13 }}>We will confirm your reservation within 24 hours.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit}>
            <div className="reserv-inline-grid">
              <div className="reserv-inline-field">
                <label htmlFor="ri-name">Full Name</label>
                <input id="ri-name" type="text" className="form-control" placeholder="Your name" required />
              </div>
              <div className="reserv-inline-field">
                <label htmlFor="ri-phone">Phone</label>
                <input id="ri-phone" type="tel" className="form-control" placeholder="+66 xx xxx xxxx" required />
              </div>
              <div className="reserv-inline-field">
                <label htmlFor="ri-guests">Guests</label>
                <select id="ri-guests" className="form-control" required defaultValue="">
              ...
              <div className="reserv-inline-field">
                ...
                <input id="ri-date" type="date" className="form-control" min={today} required />
              </div>
              <div className="reserv-inline-field">
                <label htmlFor="ri-time">Time</label>
                <select id="ri-time" className="form-control" required defaultValue="">
                  <option value="" disabled>Select</option>
              ...
              <div className="reserv-inline-btn">
                <label style={{ opacity: 0, userSelect: 'none', fontSize: 10 }}>Book</label>
            ...
            <div style={{ display: 'flex', gap: 32, justifyContent: 'center', marginTop: 36, flexWrap: 'wrap' }}>
              {['Free cancellation up to 24h','Instant confirmation','No credit card required'].map(t => (
                <div key={t} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <div style={{ width: 18, height: 18, borderRadius: '50%', background: 'rgba(113,184,95,0.15)', border: '1px solid var(--green)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
